        ...
        if (checkOrder) {
            ...
            for (OrderDetail orderDetail1 : newOrder.getListOrderDetail()) {
                if (orderDetail1.getProduct().getProductID() == product.getProductID()
                        && orderDetail1.getColor().equals(color.getColorName())
                        && orderDetail1.getSize().equals(size.getSizeName())
                        && orderDetail1.getOrder().getUser().getUserID() == cartCreate.getUserID()) {
                    check = true;
